//
// Created by wujiahao on 2018/4/7.
//

#ifndef PNOHS_SIMPLE_HBV_MODEL_H
#define PNOHS_SIMPLE_HBV_MODEL_H
...
public:
    SimpleHBVModel(double T_t, double DD, double FC, double Beta, double C, double PWP, double K_0, double K_1,
...
#endif //PNOHS_SIMPLE_HBV_MODEL_H
